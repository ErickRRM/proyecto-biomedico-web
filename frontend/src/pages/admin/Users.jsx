...
export default function Users() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validación en frontend: contraseñas deben coincidir
      ...
      {loading ? (
        ...
        <div style={styles.tableWrap}>
          <table style={styles.table}>
            <thead>
              <tr>
                {['ID', 'Nombre', 'Correo', 'Rol', 'Estado', 'Último acceso', 'Acciones'].map(h => (
        ...
        <div style={styles.overlay}>
          <div style={styles.modal}>
            ...
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              {/* Confirmar contraseña — siempre visible al crear, visible al editar solo si escribe algo */}
...
const styles = {
  container:    { padding: '32px', fontFamily: 'system-ui, sans-serif', maxWidth: '1100px', margin: '0 auto' },
